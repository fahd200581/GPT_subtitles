...
class SubtitleProcessor:
    ...
    def transcribe_audio(self):
        if self.model == 'large':
            self.model = 'large-v2' # using v2 for faster-whisper
        ...
        print(f"Word level segments are saved at {word_list_file}")
    ...
    def add_dual_subtitles(self, eng_transcript, translated_transcript):
        ...
        print(f'Combined translated subtitle is saved at {sub_translated}')
    ...
    def translate_with_whisper(self, language):
        ...
        if language == 'en':
            ...
            print(f"Attempting to translate to {language}. Note, it is not officially supported by the Whisper model.")
...
if __name__ == "__main__":
    ...
    if args.no_transcribe and args.translation_method == 'no_translate':
        print("There is nothing to do. Exiting the program.")
